...
hi Comment term=bold ctermfg=LightBlue guifg=#8080ff
hi Constant term=underline ctermfg=LightRed guifg=#c00058
hi Special term=bold ctermfg=6 guifg=SlateBlue
hi Identifier term=underline ctermfg=6 guifg=DarkCyan
hi Statement term=bold ctermfg=3 gui=bold guifg=Brown
hi PreProc term=underline ctermfg=6 guifg=Cyan
