...
" Normal mode
let s:N1 = [ '#141413' , '#d6d5d4' , 232 , 252 ] " blackestgravel & bleaksand
let s:N2 = [ '#d6d5d4' , '#45413b' , 252, 238 ] " bleaksand & deepgravel
...
let s:I2 = [ '#d6d5d4' , '#45413b' , 252 , 238 ] " bleaksand & deepgravel
...
let s:V3 = [ '#88633f' , '#d6d5d4' , 95 , 252 ] " cappuccino & bleaksand
